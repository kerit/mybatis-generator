 ...
 * following usercenter (all are optional):
 * 
 * cache_eviction
 * cache_flushInterval
 * cache_size
 ...
 * cache_type
 * 
 * All usercenter correspond to usercenter of the MyBatis cache element and
 * are passed "as is" to the corresponding usercenter of the generated cache
 * element.  All usercenter can be specified at the table level, or on the
