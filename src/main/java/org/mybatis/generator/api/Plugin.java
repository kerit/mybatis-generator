...
public interface Plugin {
 ...
 RECORD_WITH_BLOBS
    ...
    /**
     * Set usercenter from the plugin configuration.
     *
     * @param properties
     *            the new usercenter
     */
     ...
     * it can run or not. For example, if the plugin requires certain usercenter
     * to be set, and the usercenter are not set, then the plugin is invalid and
     * will not run.
     * 
     * @param warnings
